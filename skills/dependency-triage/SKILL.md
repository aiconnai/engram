...
description: Use for an Engram dependency triage loop that watches advisories and lockfiles, proposes patch-only updates, rejects major upgrades without approval, and records reproducible verification commands.
---

# Dependency Sweeper Triage Loop

Use this skill to watch dependency alerts and propose low-risk patch candidates
only. Pair it with `skills/loop-engineering/SKILL.md` for the global Engram loop
guardrails and the full harness gate.
