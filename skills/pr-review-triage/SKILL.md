...
description: Use for an Engram PR babysitter triage loop that monitors PR aging, CI blocks, reviewer threads, and lightweight action proposals with isolated-worktree fix candidates and human escalation for risky changes.
---
...
- Do not resolve reviewer comments unless the verifier confirms the diff and
  intent.
- Do not edit auth, storage migrations, protocol surfaces, attestation/snapshot
  code, production infrastructure, secrets, release workflows, or MCP write
