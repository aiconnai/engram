...
**Task**: enrichment-audit-subsecond-replay
**Mode**: pre
**Date (UTC)**: 2026-06-21
...
Harness script changes detected:
...
```diff
commit 4a27698fc769e9d3b72526940bad480aff5c9bc0
Author: Ronaldo Martins <ron@ldinho.com.br>
Date:   Sun Jun 21 17:25:39 2026 -0300

    fix: constant-time API key compare + clean up engram-wasm clippy
...
index 2f497a5..b22033f 100644
--- a/CHANGELOG.md
+++ b/CHANGELOG.md
@@ -16,0 +17,10 @@ package registries, and dated external sources.
...
@@ -935,0 +946,2 @@ This release brings Engram to full feature parity with [Memora](https://github.c
+- **0.22.0** - SDK/client consistency cleanup, release hygiene hardening, and
+  docs consistency updates
@@ -951,0 +964 @@ This release brings Engram to full feature parity with [Memora](https://github.c
+[0.22.0]: https://github.com/aiconnai/engram/compare/v0.21.2...v0.22.0
diff --git a/Cargo.lock b/Cargo.lock
index 2ac8a04..90edd31 100644
--- a/Cargo.lock
+++ b/Cargo.lock
@@ -1953 +1953 @@ name = "engram-core"
-version = "0.21.2"
+version = "0.22.0"
diff --git a/Cargo.toml b/Cargo.toml
index 5bebbee..86c7ab0 100644
--- a/Cargo.toml
+++ b/Cargo.toml
@@ -3 +3 @@ name = "engram-core"
-version = "0.21.2"
+version = "0.22.0"
diff --git a/README.md b/README.md
index eb0e2e2..cd273a4 100644
--- a/README.md
+++ b/README.md
@@ -469 +469 @@ The MCP tool reference is generated from source of truth (`src/mcp/tools/registr
-### Planned Dream Snapshot Review
+### Dream Snapshot Review Pipeline
@@ -471,3 +471,3 @@ The MCP tool reference is generated from source of truth (`src/mcp/tools/registr
...
@@ -1071 +1071 @@ Runs the 3-phase retention pipeline:
...
@@ -1073,2 +1073,2 @@ synthesis workflow. Dream jobs produce candidates for summaries, preferences,
...
@@ -1087 +1087 @@ Safety boundary:
-Implementation and eval details:
+Implementation and rollout details:
@@ -1091,0 +1092,3 @@ Implementation and eval details:
...
+
@@ -1093,2 +1096,3 @@ The generated MCP tool reference remains the source of truth for live tools.
...
+`dream-phase` feature.
@@ -1972 +1976 @@ Intent-aware unified retrieval — combines semantic search, graph traversal, an
-*Engram v0.21.2 - AI Memory Engine*
+*Engram v0.22.0 - AI Memory Engine*
diff --git a/docs/GETTING_STARTED.md b/docs/GETTING_STARTED.md
index 2b105aa..54927ed 100644
--- a/docs/GETTING_STARTED.md
+++ b/docs/GETTING_STARTED.md
@@ -29 +29 @@ contain both `engram-server` and `engram-cli`.
-VERSION=v0.21.2
+VERSION=v0.22.0
diff --git a/docs/SCHEMA.md b/docs/SCHEMA.md
index d38aff6..2667c46 100644
--- a/docs/SCHEMA.md
+++ b/docs/SCHEMA.md
@@ -11 +11 @@ source. The current source-of-truth schema version is `SCHEMA_VERSION` in
...
diff --git a/docs/USING_ENGRAM_IN_A_REPO.md b/docs/USING_ENGRAM_IN_A_REPO.md
index 9edeb6d..75af81f 100644
--- a/docs/USING_ENGRAM_IN_A_REPO.md
+++ b/docs/USING_ENGRAM_IN_A_REPO.md
@@ -499 +499 @@ The skill uses the same underlying tools shown above:
-## Planned Dream Snapshot Review
+## Dream Snapshot Review Pipeline
@@ -501,4 +501,8 @@ The skill uses the same underlying tools shown above:
...
+should not be used.
@@ -512,2 +516,2 @@ the no-mutation-before-apply boundary.
...
diff --git a/docs/harness/GATES.md b/docs/harness/GATES.md
index bbb3512..642579a 100644
--- a/docs/harness/GATES.md
+++ b/docs/harness/GATES.md
@@ -24 +24,2 @@ Ele executa (em ordem):
...
@@ -32,0 +34,20 @@ ambiente. O output humano continua sendo o default.
+### PR Title Policy
+
...
+esse contrato vivo.
+
diff --git a/docs/harness/bin/pr-title-policy.sh b/docs/harness/bin/pr-title-policy.sh
new file mode 100755
index 0000000..00ef9ee
--- /dev/null
+++ b/docs/harness/bin/pr-title-policy.sh
@@ -0,0 +1,83 @@
+#!/usr/bin/env bash
+
+set -euo pipefail
...
diff --git a/docs/harness/bin/sensors.sh b/docs/harness/bin/sensors.sh
index f820ee6..dd72ed2 100755
--- a/docs/harness/bin/sensors.sh
+++ b/docs/harness/bin/sensors.sh
@@ -214,0 +215,27 @@ run_step() {
+run_expected_exit() {
+  local label="$1"
+  local expected="$2"
+  shift 2
...
diff --git a/docs/harness/canvas/2026-06-21-b1-pr-title-policy.md b/docs/harness/canvas/2026-06-21-b1-pr-title-policy.md
new file mode 100644
index 0000000..67eca47
--- /dev/null
+++ b/docs/harness/canvas/2026-06-21-b1-pr-title-policy.md
@@ -0,0 +1,50 @@
...
index c6608e8..6c6c04d 100644
--- a/docs/harness/progress.md
+++ b/docs/harness/progress.md
@@ -680,0 +681,30 @@ Limite deliberado: o full `bash docs/harness/bin/sensors.sh` nao foi executado n
+
...
index facfd08..764f534 100644
--- a/docs/loops/agentshield-scan/STATE.md
...
index 1566d84..7926bbe 100644
--- a/docs/releases/README.md
+++ b/docs/releases/README.md
@@ -19,2 +19,2 @@ documentation hygiene, claim hygiene, token/secret rotation, and other changes
-that do not alter public runtime behavior. After `v0.21.2`, that next patch
-version is `0.21.3`.
+that do not alter public runtime behavior. After `v0.22.0`, that next patch
+version is `0.22.1`.
```
